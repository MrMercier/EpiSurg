...
flirt_episurg -in $2  -ref $elecReconPath/T1.nii.gz -out $elecReconPath/ctINt1.nii.gz -omat $elecReconPath/ct2t1.mat -interp trilinear -cost mutualinfo -dof 6 -searchcost mutualinfo -searchrx -180 180 -searchry -180 180 -searchrz -180 180
# Make directory store coregistration images
mkdir -p $elecReconPath/PICS/COREG/

# Make images of CT/MRI coregistration
slices_episurg $elecReconPath/ctINt1.nii.gz $elecReconPath/T1.nii.gz
slices_episurg $elecReconPath/T1.nii.gz  $elecReconPath/ctINt1.nii.gz
# Make gifs of those images
slices_episurg $elecReconPath/ctINt1.nii.gz $elecReconPath/T1.nii.gz -o $elecReconPath/PICS/COREG/ctINt1_1.gif
slices_episurg $elecReconPath/T1.nii.gz  $elecReconPath/ctINt1.nii.gz -o $elecReconPath/PICS/COREG/ctINt1_2.gif
